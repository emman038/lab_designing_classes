public class Runner {
    ...
    public static void rectangleDemo(){
       ...
       System.out.println("The rectangle has an area of " + rectangle.area());
    ...
    public static void computerDemo(){
        ...
        Computer computer = new Computer(500,"HP");
        ...
        computer.setPrinterModel("Microsoft");
